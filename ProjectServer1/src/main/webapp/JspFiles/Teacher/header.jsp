...
<header class="header-top">
       <%if(!Objects.equals(session.getAttribute("category"),"Преподаватель"))
{%>
...
<%} %>
      ...
      <input class="size fotobiti" type="image" src="public/images/logoBiti1.png" href="Autorization">
        ...
        <i class="menucolor">Преподаватель: <%= GetCookie.GetCookie(request, "fname")+" "+GetCookie.GetCookie(request, "name").charAt(0)+". "+GetCookie.GetCookie(request, "oname").charAt(0)+"."%></i>
