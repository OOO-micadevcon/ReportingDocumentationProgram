...
<%if(!Objects.equals(session.getAttribute("category"),"Администратор"))
{%>
...
<%} %>
      ...
      <input class="size fotobiti" type="image" src="public/images/logoBiti1.png" href="Autorization">
        ...
        <i class="menucolor">Администратор: <%= GetCookie.GetCookie(request, "fname")+" "+GetCookie.GetCookie(request, "name").charAt(0)+". "+GetCookie.GetCookie(request, "oname").charAt(0)+"."%></i>
